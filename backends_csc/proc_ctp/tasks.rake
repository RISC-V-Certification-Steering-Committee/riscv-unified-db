...
PROC_CTP_DOC_DIR = Pathname.new "#{$root}/backends_csc/proc_ctp"
...
Dir.glob("#{$root}/arch/proc_cert_model/*.yaml") do |f|
  ...
  file "#{PROC_CTP_GEN_DIR}/adoc/#{model_name}-CTP.adoc" => [
    ...
    "#{$root}/lib_csc/arch_obj_models/certificate.rb",
    "#{$root}/lib_csc/arch_obj_models/portfolio.rb",
    "#{$root}/lib_csc/portfolio_design.rb",
    "#{$root}/lib_csc/design.rb",
    "#{$root}/backends_csc/portfolio/templates/ext_appendix.adoc.erb",
    "#{$root}/backends_csc/portfolio/templates/inst_appendix.adoc.erb",
    "#{$root}/backends_csc/portfolio/templates/csr_appendix.adoc.erb",
    "#{$root}/backends_csc/portfolio/templates/beginning.adoc.erb",
    "#{$root}/backends_csc/portfolio/templates/normative_rules.adoc.erb",
    "#{$root}/backends_csc/portfolio/templates/test_procedures.adoc.erb",
    "#{$root}/backends_csc/proc_cert/templates/typographic.adoc.erb",
    "#{$root}/backends_csc/proc_cert/templates/rev_history.adoc.erb",
    "#{$root}/backends_csc/proc_cert/templates/related_specs.adoc.erb",
    "#{$root}/backends_csc/proc_cert/templates/priv_modes.adoc.erb",

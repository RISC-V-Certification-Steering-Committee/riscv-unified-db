...
BACKEND_DIR = "#{$root}/backends_csc/#{BACKEND_NAME}"
...
src_pnames = [
  ...
  "#{$root}/lib_csc/architecture.rb",
  "#{$root}/lib_csc/version.rb",
  "#{$root}/lib_csc/presence.rb",
  "#{$root}/lib_csc/backend_helpers.rb",
  "#{$root}/lib_csc/arch_obj_models/database_obj.rb",
  "#{$root}/lib_csc/arch_obj_models/extension.rb",
  "#{$root}/lib_csc/arch_obj_models/instruction.rb"
]
